        ...
        <ul class="sidebar-nav list-unstyled">
          ...
          <li class="sidebar-item">
            ...
            <ul id="charts" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
              <li class="sidebar-item">
                <a href="pie_chart.php" class="sidebar-link">Pie Chart</a>
              </li>
              <li class="sidebar-item">
                <a href="bar_chart.php" class="sidebar-link">Line Chart</a>
              </li>
            </ul>
          </li>
        </ul>
      ...
      <nav class="navbar navbar-expand px-3 border-bottom navbar-light bg-light fixed-top" id="navbar">
        <div class="container-fluid">
          <button class="btn" id="sidebar-toggle" type="button">
            ...
            <span class="ms-2 d-none d-md-inline fs-5">Pie Chart</span>
          </button>
