...
<head>
  ...
  <title>Smart Flood Data Table</title>
...
<body>
  <div class="wrapper d-flex">
    ...
    <div class="main flex-grow-1">
      ...
      <!-- Content Area -->
      <main class="content px-3" id="content" style="padding-top: 5rem; padding-bottom: 3rem">
        <!-- Data Table -->
        <div class="container-data border shadow rounded-4 bg-white">
          ...
          <div id="printableArea" class="container-table px-2 pb-2 table-responsive">
